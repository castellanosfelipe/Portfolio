...
class FluidCursorEl extends HTMLElement {
  connectedCallback() {
    if (this._done) return; this._done = true;
    this.style.cssText = 'position:fixed;top:0;left:0;z-index:0;pointer-events:none;display:block;';
    const c = document.createElement('canvas');
    c.id = 'fluid';
    c.style.cssText = 'width:100vw;height:100vh;display:block;';
    this.appendChild(c);
    try { useFluidCursor(); } catch (e) { console.warn('fluid cursor failed', e); }
  }
}
if (!customElements.get('fluid-cursor')) customElements.define('fluid-cursor', FluidCursorEl);
